...
export default class BurgerMenu {
    ...
    onBurgerClick() {
        ...
        // переключение класса иконки (бургер - крестик)
        this.burgerButton.classList.toggle(this.config.BURGER_BUTTON_ACTIVE, isOpen);
        
        this.burgerButton.setAttribute('aria-label', isOpen
    ...
    hideBurgerMenu() {
        ...
        this.burgerButton.classList.remove(this.config.BURGER_BUTTON_ACTIVE);
